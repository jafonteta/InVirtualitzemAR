...
public class TapToPlace : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        TrackableType.PlaneWithinPolygon))
        {
            ...
            TrackableId planeId = s_Hits[0].trackableId; //get the ID of
                                                         //the plane hit by the raycast
            var referencePoint =
            m_ReferencePointManager.AttachAnchor(m_PlaneManager.GetPlane(planeId), hitPose);
